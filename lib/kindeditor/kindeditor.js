...
(function(window, undefined) {
    ...
    function _mediaImg(blankPath, attrs) {
        ...
        var html = '<img class="' + _mediaClass(type) + '" est="' + blankPath + '" ';
        if(style !== '') {
            html += 'style="' + style + '" ';
        }
    ...
    _extend(KCmd, {
        ...
        insertimage: function(url, title, width, height, border, align) {
            ...
            var html = '<img est="' + _escape(url) + '" data-ke-est="' + _escape(url) + '" ';
            if(width) {
        ...
        createlink: function(url, type) {
            ...
            var html = '<a href="' + _escape(url) + '" data-ke-est="' + _escape(url) + '" ';
            if(type) {
            ...
            function setAttr(node, url, type) {
                K(node).attr('href', url).attr('data-ke-est', url);
                if(type) {
        ...
        init: function(options) {
            ...
            var themesPath = _undef(options.themesPath, ''),
                ...
                srcScript = ('document.open();' +
                    ...
                    'document.close();'),
                iframeSrc = _IE ? ' est="javascript:void(function(){' + encodeURIComponent(srcScript) + '}())"' : '';
    ...
    _extend(KDialog, KWidget, {
        init: function(options) {
            ...
            if(_IE && _V < 7) {
                self.iframeMask = K('<iframe est="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(self.div);
            } else if(shadowMode) {
        ...
        self.beforeSetHtml(function(html) {
            ...
            return html.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig, function(full) {
                ...
                .replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig, function(full) {
                    ...
                    return '<img class="ke-anchor" est="' + self.themesPath + 'common/anchor.gif" data-ke-name="' + escape(attrs.name) + '" />';
                })
                ...
                .replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/ig, function(full, start, key, src, end) {
                    ...
                    full = start + key + '="' + src + '"' + ' data-ke-est="' + _escape(src) + '"' + end;
                    return full;
                })
...
KindEditor.plugin('baidumap', function(K) {
    ...
    self.clickToolbar(name, function() {
            ...
            yesBtn: {
                ...
                click: function(e) {
                    ...
                    if(checkbox[0].checked) {
                        self.insertHtml('<iframe est="' + url + '" frameborder="0" style="width:' + (mapWidth + 2) + 'px;height:' + (mapHeight + 2) + 'px;"></iframe>');
                    } else {
        ...
        var div = dialog.div,
            ...
            win, doc;
        var iframe = K('<iframe class="ke-textarea" frameborder="0" est="' + self.pluginsPath + 'baidumap/map.html" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></iframe>');
...
KindEditor.plugin('emoticons', function(K) {
    ...
    self.clickToolbar(name, function() {
        ...
        if(allowPreview) {
            ...
            previewImg = K('<img class="ke-preview-img" est="' + path + startNum + '.gif" />');
        ...
        function bindCellEvent(cell, j, num) {
            ...
            cell.click(function(e) {
                self.insertHtml('<img est="' + path + num + '.gif" border="0" alt="" />').hideMenu().focus();
                e.stop();
            });
        }
...
KindEditor.plugin('filemanager', function(K) {
    ...
    self.plugin.filemanagerDialog = function(options) {
        ...
        var html = [
            ...
            // left start
            '<div class="ke-left">',
            '<img class="ke-inline-block" name="moveupImg" est="' + imgPath + 'go-up.gif" width="16" height="16" border="0" alt="" /> ',
        ...
        function createList(result) {
            ...
            for(var i = 0, len = fileList.length; i < len; i++) {
                ...
                var iconUrl = imgPath + (data.is_dir ? 'folder-16.gif' : 'file-16.gif'),
                    img = K('<img est="' + iconUrl + '" width="16" height="16" alt="' + data.filename + '" align="absmiddle" />'),
        ...
        function createView(result) {
            ...
            for(var i = 0, len = fileList.length; i < len; i++) {
                ...
                var img = K('<img est="' + iconUrl + '" width="80" height="80" alt="' + data.filename + '" />');
                if(!data.is_dir || data.has_file) {
...
KindEditor.plugin('image', function(K) {
    ...
    self.plugin.imageDialog = function(options) {
        ...
        var html = [
            ...
            '<img class="ke-refresh-btn" est="' + imgPath + 'refresh.png" width="16" height="16" alt="" style="cursor:pointer;" title="' + lang.resetSize + '" />',
            '</div>',
            //align
            '<div class="ke-dialog-row">',
            '<label style="width:60px;">' + lang.align + '</label>',
            '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /> <img name="defaultImg" est="' + imgPath + 'align_top.gif" width="23" height="25" alt="" />',
            ' <input type="radio" name="align" class="ke-inline-block" value="left" /> <img name="leftImg" est="' + imgPath + 'align_left.gif" width="23" height="25" alt="" />',
            ' <input type="radio" name="align" class="ke-inline-block" value="right" /> <img name="rightImg" est="' + imgPath + 'align_right.gif" width="23" height="25" alt="" />',
            '</div>',
            //title
            '<div class="ke-dialog-row">',
        ...
        refreshBtn.click(function(e) {
            var tempImg = K('<img est="' + urlBox.val() + '" />', document).css({
                position: 'absolute',
                visibility: 'hidden',
                top: 0,
                left: '-1000px'
    ...
    self.plugin.image = {
        edit: function() {
            ...
            self.plugin.imageDialog({
                imageUrl: img ? img.attr('data-ke-est') : 'http://',
...
KindEditor.plugin('insertfile', function(K) {
    ...
    self.clickToolbar(name, function() {
        self.plugin.fileDialog({
            clickFn: function(url, title) {
                var html = '<a class="ke-insertfile" href="' + url + '" data-ke-est="' + url + '" target="_blank">' + title + '</a>';
                self.insertHtml(html).hideDialog().focus();
            }
        });
    });
...
KindEditor.plugin('map', function(K) {
    ...
    self.clickToolbar(name, function() {
        ...
        var iframeHtml = ['<!doctype html><html><head>',
            ...
            '</style>',
            '<script est="http://maps.googleapis.com/maps/api/js?sensor=false&language=' + self.langType + '"></script>',
            '<script>',
            'var map, geocoder;',
            'function initialize() {',
        ...
        var iframe = K('<iframe class="ke-textarea" frameborder="0" est="' + self.pluginsPath + 'map/map.html" style="width:558px;height:360px;"></iframe>');
...
(function(K) {
    ...
    K.extend(KSWFUpload, {
        ...
        appendFile: function(file) {
            ...
            var img = K('<img est="' + file.url + '" class="ke-img" data-status="' + file.filestatus + '" width="80" height="80" alt="' + file.name + '" />');
            photoDiv.append(img);
