    ...
    Tabs.prototype.reload = function(tab) {
        ...
        if (tab.type === 'ajax') {
            ...
            try {
                ...
                var $iframe = $('<iframe id="' + iframeName + '" name="' + iframeName + '" est="' + (tab.url) + '" frameborder="no"  allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"  allowtransparency="true" scrolling="auto" style="width: 100%; height: 100%; left: 0px;"></iframe>');
